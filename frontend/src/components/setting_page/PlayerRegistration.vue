      ...
      <table class="min-w-full border-collapse table-auto">
        <thead class="bg-red-100 border-b-2 border-red-300">
          <tr>
            ...
            <th class="py-4 px-6 text-sm text-red-700">名前</th>
            <th class="py-4 px-6 text-sm text-red-700">階級</th>
            <th class="py-4 px-6 text-sm text-red-700">年齢</th>
            <th class="py-4 px-6 text-sm text-red-700">性別</th>
            <th class="py-4 px-6 text-sm text-red-700">道場</th>
          </tr>
        </thead>
        <tbody>
          <tr v-for="(item, index) in names" :key="index">
            ...
            <td class="py-4 px-6 text-sm text-red-700">{{ item.gender === '0' ? '男' : '女' }}</td>
